...
from similarity_cython.SLIM_BPR.SLIM_BPR_Python import SLIM_BPR_Python
import subprocess
import os, sys
import numpy as np
...
class SLIM_BPR_Cython(SLIM_BPR_Python):
    ...
    def fit(self, epochs=30, logFile=None, URM_test=None, minRatingsPerUser=1,
        ...
        from similarity_cython.SLIM_BPR.Cython.SLIM_BPR_Cython_Epoch import SLIM_BPR_Cython_Epoch
